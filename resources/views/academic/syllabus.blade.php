                ...
                <form action="{{ route('saveSyllabus') }}" class="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            ...
                            <x-delete-action :action="route('delSyllabusContent',['id'=>$itemId])" class="fw-bold text-danger">Delete</x-delete-action>
                        </div>
                        @else
                        ...
                        @endphp
                            <tr>
                                ...
                                <td>
                                        ...
                                        <x-delete-action :action="route('delSyllabus',['id'=>$item->id])"><i class="fa-solid fa-trash mx-2" style="color: #c10b26;"></i></x-delete-action>
                                </td>
                            </tr>
                        @endforeach
                        @else
