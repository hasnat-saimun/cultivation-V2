    ...
    <div class="col-12 col-md-10 mx-auto">
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <p class="text-muted">Upload a CSV to add/update staff. Existing rows are matched by the field you choose below.</p>
                <div class="mb-3">
...
<pre class="bg-light p-3 border">staffId,firstName,lastName,email,joinDate,mobile,designation,gender,dob
S-1001,Karim,Ali,karim@example.com,2023-02-14,01733333333,Office Assistant,Male,1992-07-08
S-1002,Sadia,Khan,sadia@example.com,2022-11-20,01744444444,Accountant,Female,1989-09-30</pre>
