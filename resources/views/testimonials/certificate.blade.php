            ...
            <div class="card-header bg-white py-1 header-block">
                ...
                <div class="text-center">
                    ...
                    <div style="font-size:12.5px;line-height:1.2;white-space:normal;">
                        <div class="fw-bold" style="font-size:15px!important;line-height:1.3">{{ $address }}</div><div class="fw-bold"> @if($establishDate) Estd. {{ $establishDate }} @endif </div><div class="fw-bold"> @if(!empty($email)) Email: {{ $email }} @endif @if(!empty($mobile)), Mobile: {{ $mobile }} @endif</div>
                    </div>
