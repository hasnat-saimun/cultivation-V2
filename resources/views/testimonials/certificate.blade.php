 ...
 <div class="row justify-content-center">
    ...
    <div class="col-lg-10">
        <style>
            ...
            .wm-logo{position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);opacity:0.08;width:37%;max-width:460px;z-index:0;pointer-events:none;user-select:none;filter:grayscale(100%);-webkit-filter:grayscale(100%) opacity(0.08);-webkit-print-color-adjust:exact;print-color-adjust:exact;image-rendering:-webkit-optimize-contrast}
            ...
            <div class="card-header bg-white py-1 header-block">
                ...
                <div class="text-center">
                    ...
                    <div style="font-size:12.5px;line-height:1.2;white-space:normal;">
                        <div class="fw-bold" style="font-size:20px!important;line-height:1.3">{{ $address }}</div><div class="fw-bold"> @if($establishDate) Estd. {{ $establishDate }} @endif </div><div class="fw-bold"> @if(!empty($email)) Email: {{ $email }} @endif @if(!empty($mobile)), Mobile: {{ $mobile }} @endif</div>
                    </div>
