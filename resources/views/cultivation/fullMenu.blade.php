...
<ul class="nav nav-sidebar-menu sidebar-toggle-view">
    ...
    @php
        $admissionRoutes = ['admitStudent','studentList','studentPromotion','studentPhotoBulk','student.idcards.bulk','studentBulkUpdate'];
    ...
    <li class="nav-item sidebar-nav-item {{ $admissionOpen ? 'open' : '' }}" data-group="admin-admission">
        ...
        <ul class="nav sub-group-menu{{ $admissionOpen ? ' menu-open' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('studentBulkUpdate') }}" class="nav-link {{ request()->routeIs('studentBulkUpdate') ? 'active' : '' }}"><i class="fas fa-angle-right"></i>Bulk Details Update</a>
            </li>
            <li class="nav-item">
