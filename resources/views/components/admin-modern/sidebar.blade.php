...
SVG,
    ...
    $groups = [
        ...
        ['label' => 'Attendance', 'route' => 'adminModernAttendanceIndex', 'icon' => 'attendance'],
        ['label' => 'Attendance Report', 'route' => 'adminModernAttendanceReport', 'icon' => 'attendance'],
        ['label' => 'Monthly Attendance', 'route' => 'adminModernAttendanceMonthly', 'icon' => 'attendance'],
