                    ...
                    <div class="col-12  mx-auto">
                        <div class="card card-default shadow-sm">
                            <div class="card-header bg-gradient-success text-white">
                                <h3 class="mb-0"><i class="fa-solid fa-user-tie"></i> All Staff Members</h3>
                                <div class="d-flex gap-3 flex-wrap" style="margin-top: 0.5rem;">
                                    <a href="{{ route('staff.export.pdf') }}" class="btn btn-light btn-sm"><i class="fa-solid fa-file-pdf"></i> Export PDF</a>
                                    <a href="{{ route('staffBulkUpdate') }}" class="btn btn-warning btn-sm"><i class="fa-solid fa-edit"></i> Bulk Update</a>
                                    <a href="{{ route('staffBulkUpload') }}" class="btn btn-info btn-sm"><i class="fa-solid fa-upload"></i> Bulk Upload</a>
                                    <a href="{{ route('addStaff') }}" class="btn btn-dark btn-sm"><i class="fa-solid fa-plus"></i> Add Staff</a>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <table id="myTable" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($profileData as $staff)
                                            <tr class="data-row">
                                                <td>
                                                    <input type="checkbox" class="row-checkbox form-check-input" value="{{ $staff->id }}">
                                                </td>
                                                <td>{{ $staff->staffId }}</td>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('viewStaff',  ['profileId'=>$staff->id]) }}" class="btn btn-sm btn-info" title="View"><i class="fa-solid fa-eye"></i></a>
                                                    <a href="{{ route('editStaff',['profileId'=>$staff->id]) }}" class="btn btn-sm btn-primary" title="Edit"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    <a href="#" class="btn btn-sm btn-danger delete-single" data-id="{{ $staff->id }}" data-name="{{ $staff->firstName }}" title="Delete"><i class="fa-solid fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        @else
